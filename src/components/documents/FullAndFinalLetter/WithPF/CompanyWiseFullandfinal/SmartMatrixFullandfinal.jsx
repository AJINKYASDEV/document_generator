      ...
      <TableContainer component={Paper} sx={{ border: "1.5px solid #000" }}>
        <Table size="small">
          <TableBody>
            ...
            {/* ===== TITLE ===== */}
            <TableRow>
              <TableCell colSpan={4} sx={{ ...bold, ...center, background: "#d9d9d9" }}>
            ...
            <TableRow sx={{ background: "#d9d9d9" }}>
              <TableCell colSpan={2} sx={bold}>Salary particulars</TableCell>
              <TableCell sx={{ ...bold, textAlign: "center" }}>For the month</TableCell>
            ...
            {/* ===== EARNINGS ===== */}
            <TableRow sx={{ background: "#d9d9d9" }}>
              <TableCell colSpan={2} sx={bold}>Earnings</TableCell>
              <TableCell sx={{ ...bold, textAlign: "center" }}>Actual</TableCell>
              <TableCell sx={{ ...bold, textAlign: "center" }}>Earned</TableCell>
            </TableRow>
            ...
            <TableRow>
              <TableCell colSpan={2} sx={bold}>Total</TableCell>
            ...
            <TableRow>
              <TableCell colSpan={3} sx={bold}>Total Deductions</TableCell>
              <TableCell sx={right}>{formatCurrency(totalDeductions)}</TableCell>
            </TableRow>

            {/* ===== NET PAY ===== */}
            <TableRow>
              <TableCell colSpan={3} sx={bold}>Net Payable (Rs)</TableCell>
            ...
            <TableRow>
              ...
              <TableCell colSpan={2} align="center">Approved By</TableCell>
            </TableRow>
